function main()
   ...
   cHtml += "        if (ttsEnabled) { btn.innerHTML = '🔊'; btn.style.opacity = '1'; } else { btn.innerHTML = '🔇'; btn.style.opacity = '0.5'; if (window.speechSynthesis) window.speechSynthesis.cancel(); }"
   cHtml += "    }"
