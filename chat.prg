function main()
   ...
   cHtml += "        .token-counter span.cost { font-weight: bold; color: #4ade80; }"
   ...
   cHtml += "        <div id='token-counter' class='token-counter'>Tokens: 0 <span class='cost'>$0.0000</span></div>"
   ...
   cHtml += "                                document.getElementById('token-counter').innerHTML = 'Tokens: ' + total_tokens + ' <span class=\"cost\">$' + cost + '</span>';"
   cHtml += "                            }"
   ...
   cHtml += "        document.getElementById('token-counter').innerHTML = 'Tokens: 0 <span class=\"cost\">$0.0000</span>';"
   cHtml += "    }"
   cHtml += "</script>"
   cHtml += "</body></html>"
